...
class Node {
  public:
    ...
    Node(unsigned short id, size_t nrules, bool prediction, bool default_prediction,
         double lower_bound, double objective, Node* parent,
         size_t num_captured, double equivalent_minority, double proportion, double default_objective);
    ...
    inline double default_objective() const;
...
class CuriousNode: public Node {
    public:
        CuriousNode(unsigned short id, size_t nrules, bool prediction, bool default_prediction,
             ...
             size_t num_captured, double equivalent_minority, double proportion, double default_objective) : Node(id, nrules, prediction, default_prediction,
                 lower_bound, objective, (Node*)parent, num_captured, equivalent_minority, proportion, default_objective) {
...
class CacheTree {
  public:
    ...
    CacheTree(size_t nsamples, size_t nrules, double c, rule_t *rules,
              ...
              bool calculate_size, char const *type, bool wpa = false, int x = 1);
    ~CacheTree();
    ...
    Node* construct_node(unsigned short new_rule, size_t nrules,
           ...
           int nsamples, int len_prefix, double c, double equivalent_minority, double proportion, double default_objective);
...
inline double Node::default_objective() const {
    return default_objective_;
}
